...
{
    public class TriangularMovingAverageCalculatorTests
    {
        [Fact]
        public void Constructor_ShouldThrowArgumentException_WhenPeriodParameterIsMissing()
        {
            ...
            // Act & Assert
            var exception = Assert.Throws<ArgumentException>(() => new TriangularMovingAverageCalculator(parameters, nameof(CalculatorNameEnum.TMA)));
        ...
        public void Constructor_ShouldCreateInstance_WhenPeriodParameterIsPresent()
        {
            ...
            // Act
            var calculator = new TriangularMovingAverageCalculator(parameters, nameof(CalculatorNameEnum.TMA));
        ...
        public void Calculate_ShouldReturnCorrectResults_WhenParametersAreValid()
        {
            ...
            Assert.Equal(nameof(CalculatorNameEnum.TMA), result.Name);
